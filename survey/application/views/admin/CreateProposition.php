            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki" id="form_wizard_1">
                    <div class="portlet-title">
                        <div class="caption"> <i class="fa fa-gift"></i> Add Range Descriptions</div>
                                     ...
                                     <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab1">
                                                ...
                                                <div class="col-md-4">
                                                    <select name="Survey_Id" id="Survey_Id" class="form-control">
                                                        ...
                                                        <?php foreach($surveylist as $list){
															if(!in_array($list['Survey_Id'],$distinctsurveyid)){
														?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <textarea class="form-control" name="likehood_LeftText" id="likehood_LeftText" rows="5"><?php echo @$_REQUEST['likehood_LeftText'];?></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <textarea class="form-control" name="likehood_RightText" id="likehood_RightText" rows="5"><?php echo @$_REQUEST['likehood_RightText'];?></textarea>
                                            ...
                                            <h4 class="bold">Desirability:</h4>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Left Text:</label>
                                                    <div class="col-md-4">
                                                        <textarea class="form-control" name="desirable_LeftText" id="desirable_LeftText" rows="5"><?php echo @$_REQUEST['desirable_LeftText'];?></textarea>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Right Text:</label>
                                                    <div class="col-md-4">
                                                        <textarea class="form-control" name="desirable_RightText" id="desirable_RightText" rows="5"><?php echo @$_REQUEST['desirable_RightText'];?></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <textarea class="form-control" name="firstpass_CommentText" id="firstpass_CommentText" rows="5"><?php echo @$_REQUEST['firstpass_CommentText'];?></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <textarea class="form-control" name="secondpass_CommentText" id="secondpass_CommentText" rows="5"><?php echo @$_REQUEST['secondpass_CommentText'];?></textarea>
