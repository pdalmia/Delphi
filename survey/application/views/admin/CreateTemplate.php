            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki" id="form_wizard_1">
                    <div class="portlet-title">
                        <div class="caption"> <i class="fa fa-gift"></i> Add Email Template</div>
                                     ...
                                     <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab1">
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="TemplateName" id="TemplateName" class="form-control" value="<?php echo @$_REQUEST['TemplateName'];?>" placeholder="Template Name" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea class="form-control" name="TemplateText" id="TemplateText"><?php echo @$_REQUEST['TemplateText'];?></textarea>
