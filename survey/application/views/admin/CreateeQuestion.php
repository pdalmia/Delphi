												...
												<div class="col-md-4">
													<select name="Survey_Id" id="Survey_Id" class="form-control" onchange="return surveygroup(this.value);">
														...
														<?php foreach($surveylist as $list){?>
															<option value="<?php echo $list['Survey_Id'];?>" >
															<?php echo $list['Heading'];?></option> 
														<?php }?>                                                    
													</select>                                                    
...
<!--                                                    <input type="hidden" name="SurveyQuestionGroup_Id" id="SurveyQuestionGroup_Id" value="--><?php //echo $SurveyQuestionGroup_Id; ?><!--">-->
                                                    <button type="submit" name="submit" value="submit" class="btn green button-submit"> Submit <i class="m-icon-swapright m-icon-white"></i> </button>													<input type="hidden" name="base_url" id="base_url" value="<?php echo base_url();?>">
