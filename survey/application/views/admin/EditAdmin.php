            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki" id="form_wizard_1">
                    <div class="portlet-title">
                        <div class="caption"> <i class="fa fa-gift"></i> Edit Admin</div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab1">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" placeholder="First Name" maxlength="150" value="<?php echo @$data['FirstName'];?>" id="FirstName" name="FirstName">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" placeholder="Last Name" maxlength="150" value="<?php echo @$data['LastName'];?>" id="LastName" name="LastName">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="Company" maxlength="150" id="Company" value="<?php echo @$data['Company'];?>" placeholder="Organisation">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <textarea class="form-control" name="Address1" id="Address1" maxlength="500" rows="3"><?php echo @$data['Address1'];?></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <textarea class="form-control" name="Address2" id="Address2" maxlength="500" rows="3"><?php echo @$data['Address2'];?></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" placeholder="Postcode/Zip" maxlength="150" value="<?php echo @$data['ZipCode'];?>" id="ZipCode" name="ZipCode">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="Email" id="Email" readonly value="<?php echo @$data['Email'];?>" placeholder="Email Address">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input name="Password" type="password" class="form-control" maxlength="150" id="Password" value="<?php echo @$data['Password'];?>" placeholder="Password">
                                                    <div class="error" style="display:none;" id="ERROR_password"></div>
                                                </div>
                                                <span style="color:#009926">At least one letter and one number.<br>At least one special character (*&^%$#@).</span>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Phone:</label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control numeric_value" name="Phone" id="Phone" value="<?php echo @$data['Phone'];?>" maxlength="13" placeholder="Phone No">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="hidden" name="User_Id" id="User_Id" value="<?php echo @$data['Admin_Id'];?>">
