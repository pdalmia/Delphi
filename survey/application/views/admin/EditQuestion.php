                                        ...
                                        <div class="tab-pane active" id="tab1">
                                                ...
                                                <div class="col-md-4">
                                                    <select name="SurveyQuestionGroup_Id" id="SurveyQuestionGroup_Id" class="form-control">
                                                        ...
                                                        <?php foreach($questiongroup as $key=>$list){
                                                            if(@$SurveyQuestionGroup_Id==$key){$sel="selected";}else{$sel="";}
                                                            ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="hidden" name="OldSurveyQuestionGroup_Id" id="OldSurveyQuestionGroup_Id" value="<?php echo $SurveyQuestionGroup_Id; ?>">
