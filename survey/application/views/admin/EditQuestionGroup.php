<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title"> Survey Proposition Group </h3>
        <?php
            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki" id="form_wizard_1">
                    <div class="portlet-title">
                        <div class="caption"> <i class="fa fa-gift"></i> Edit Proposition Group</div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <textarea class="form-control" name="Title" id="Title" rows="5"><?php echo @$data['Title'];?></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="hidden" name="SurveyQuestionGroup_Id" id="SurveyQuestionGroup_Id" value="<?php echo $data['SurveyQuestionGroup_Id']; ?>">
