            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki" id="form_wizard_1">
                    <div class="portlet-title">
                        <div class="caption"> <i class="fa fa-gift"></i> Edit Respondent</div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <textarea class="form-control" name="Address1" id="Address1" rows="5" maxlength="500" rows="1"><?php echo @$data['Address1'];?></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <textarea class="form-control" name="Address2" id="Address2" rows="5" maxlength="500" rows="1"><?php echo @$data['Address2'];?></textarea>
                                                    <div class="error" style="display:none;" id="ERROR_address2"></div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Postcode / Zip:</label>
                                                <div class="col-md-4">
